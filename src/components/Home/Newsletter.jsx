  ...
  return (
    ...
    <Container maxW='1305px' py={{base: 9, lg: '70px'}} px={{base: 6, sm: 12}}>
      <Flex direction={{base: 'column', lg: 'row'}} alignItems='center' justifyContent='space-between' gap={10}>
        ...
        <InputGroup>
          <Input size='lg' border='2px' borderRight='0' borderRightRadius='0' borderColor='green.900' bgColor='white' placeholder='Escriba su correo aquí...' />
          <Button  
            _hover={{ bg: 'green.700' , border: '2', borderColor: 'green.900' }} 
            _active={{ bg: 'green.700', border: 'none'}} size='lg' bgColor='green.900' borderLeftRadius='0' textColor='gray.200' px='45px'>
              Enviar
          </Button>
        </InputGroup>
      </Flex>
